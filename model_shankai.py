...
results = sm.ols('Q("Daily Mean NO2 Concentration") ~ PRCP + AWND + TMAX', data = austin, missing = 'drop').fit()
results.summary()

# +
import statsmodels.formula.api as sm

results = sm.ols('Q("Daily Mean NO2 Concentration") ~ PRCP + AWND + TMAX', data = dallas, missing = 'drop').fit()
results.summary()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~ PRCP + AWND + TMAX', data = dallas, missing = 'drop').fit()
results.summary()

# +
import statsmodels.formula.api as sm

results = sm.ols('Q("DAILY AQI VALUE NO2") ~ PRCP + AWND + TMAX', data = houston, missing = 'drop').fit()
results.summary()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~ PRCP + AWND + SNWD', data = new_york, missing = 'drop').fit()
results.summary()
...
results = sm.ols('Q("Daily Mean NO2 Concentration") ~log_base_PRCP + log_base_AWND + log_base_TMAX', data=austin_select).fit()
...
results = sm.ols('Q("Daily Mean NO2 Concentration") ~log_base_PRCP + log_base_AWND + log_base_TMAX', data=houston_select).fit()
...
results = sm.ols('Q("Daily Mean NO2 Concentration") ~log_base_PRCP + log_base_AWND + log_base_TAVG', data=los_angeles_select).fit()
...
results = sm.ols('Q("Daily Mean NO2 Concentration") ~log_base_PRCP + log_base_AWND + log_base_SNWD', data=new_york_select).fit()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~log_base_PRCP + log_base_AWND + log_base_TMAX', data=austin_select).fit()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~log_base_PRCP + log_base_AWND + log_base_TMAX', data=dallas_select).fit()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~log_base_PRCP + log_base_AWND + log_base_TMAX', data=houston_select).fit()
...
results = sm.ols('Q("DAILY AQI VALUE NO2") ~log_base_PRCP + log_base_AWND + log_base_TAVG', data=los_angeles_select).fit()
